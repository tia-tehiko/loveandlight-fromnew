  ...
  return knex('candles').del()
    .then(function () {
      ...
      return knex('candles').insert([
        ...
        {id: 5,name: 'Love',price: 25,img: './images/7.jpg',details: 'Coming Soon...',inCart: false,count: 0,total: 0},
        {id: 6,name: 'Geo Large',price: 35,img: './images/4.jpg',details: 'Coming Soon...',inCart: false,count: 0,total: 0},
        {id: 7,name: 'Renee',price: 35,img: './images/2.jpg',details: 'Coming Soon...',inCart: false,count: 0,total: 0},
        {id: 8,name: 'Renee Mauve',price: 35,img: './images/5.jpg',details: 'Coming Soon...',inCart: false,count: 0,total: 0},
        {id: 9,name: 'Omg',price: 40,img: './images/2.jpg',details: 'Coming Soon...',inCart: false,count: 0,total: 0},
      ]);
    });
};
