  ...
  render() {
    return (
      <div>
        ...
        <p>
          Brisbane Metro Area - For orders up to 5kg we charge a Flat Rate of $9
        </p>
        <p>
          Australia Wide - For orders up to 5kg we charge a Flat Rate of $14
        </p>
        <p>
        ...
        <p>
          ...
          emailing loveandlighthomefragrances@gmail.com with your name, address,
